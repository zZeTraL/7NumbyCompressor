...
```{r}
data <- read.csv("./example/compression_report_2024-02-01_02-06-06.csv")
data
```

Each file that has been compressed will be logged into a log file. The log file is a csv file which contains the following columns:
